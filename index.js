...
app.post('/', (req, res) => {
  ...
  if (req.url.indexOf('/?updateConfig=') == 0) {
    ...
    async function importApps() {
      ...
      console.log('Processing ' + emailArray.length + ' rows from CSV');
      for (var x = 0; x < emailArray.length; x++) {
        ...
        console.log('Row ' + x + ': AppID=' + appId + ', Date=' + appDate + ', Parts=' + parts.length + ', BatchNum="' + existingBatchNum + '"');
      ...
      console.log('Maximum existing batch number: ' + maxBatchNum);
