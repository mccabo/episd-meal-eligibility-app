    ...
    <table id="tblMain" class="table table-light table-hover">      
      ...
      <tbody v-if="filteredIds.length>0">                          
        <tr v-for="(application,index) in filteredIds" :key="index" @mouseover="setOver(index)" @mouseleave="onLeave()" style="font-size: 20px;height: 50px">            
          ...
          <td @click="onActive(index,application.Id,application.Guardians[0].LastName,application.Guardians[0].FirstName)" style="font-size: 20px;padding-left: 0px;color: black">{{ application.Id }}</td>            
          <td @click="onActive(index,application.Id,application.Guardians[0].LastName,application.Guardians[0].FirstName)" style="font-size: 20px;padding-left: 0px;color: black">{{ application.Language }}</td>            
          <td @click="onActive(index,application.Id,application.Guardians[0].LastName,application.Guardians[0].FirstName)" style="font-size: 20px;padding-left: 0px;color: black" contenteditable="false">{{ application.Guardians[0].FirstName }}</td>            
          <td @click="onActive(index,application.Id,application.Guardians[0].LastName,application.Guardians[0].FirstName)" style="font-size: 20px;padding-left: 0px;color: black" contenteditable="false">{{ application.Guardians[0].LastName }}</td>
          <td @click="onActive(index,application.Id,application.Guardians[0].LastName,application.Guardians[0].FirstName)" style="font-size: 20px;padding-left: 0px;color: black" contenteditable="false">{{ application.Guardians[0].Email }}</td>
          ...
          <td @click="onActive(index)" contenteditable="false" style="padding-left: 40px;color: black" v-else> 
                        
          </td> 
          <td @click="onActive(index,application.Id,application.Guardians[0].LastName,application.Guardians[0].FirstName)" style="font-size: 20px;padding-left: 0px;color: black;width: 25px">{{ application.Index }}</td>            
  ...
  export default {
    ...
    setup() {
      ...
      return { printLetter,onLeave,submitEmail,submitEmails,setOver,setActive,toggleAppInfo,toggleStudentInfo,onActive,searchApps,selectedStatus,status,selectedReason,reasons,
        ...
        applications,english,spanish,sent,ids,guardians,searches,students,campus,setLogoURL,selDoc,selectDate,docEvent,setDocumentation,setDocFlag,printTest
      } 
    }
  }
</script>
