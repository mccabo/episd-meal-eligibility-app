        ...
        <div id="divUtilitiesMain" v-for="(search,i) in searches" :key="i">          
          ...
          <div v-if="i>10">            
            <div v-for="(input,j) in search.inputs" :key="j" :id="input.id" style="border: solid rgb(0, 0, 0) 0px" class="w3-margin utilities">                                                    
              <input v-if="i=='11'" :id="input.id" @mouseover="docEvent(11,0)" @click="showPDFS()" :type="input.type" :style="input.style" :class="input.class" :value="input.label" />                                                                                
  ...
  export default {
    ...
    name: "apps",
      ...
      methods: {                
        ...
        showConfig() {
          window.location.href = "http://localhost:3000?showConfig=1";
        },
        addToSelected(i) {     
