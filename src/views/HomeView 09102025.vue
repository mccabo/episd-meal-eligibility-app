<template> 
  ...
  <form action="/default-action" class="hidden">
      <input type="text" name="username">
      <input type="text" name="password">
      <button type="submit" formaction="http://localhost:3000/submit_data">Submit</button>
  </form>
  ...
  <!-- Accordian button for Utility Section -->
   <div class="w-full" style="display: inline-flex;margin: auto;justify-content: left;border: solid black 0px;background-color: #0a58ca;color: white;border-radius: 5px;
    margin-bottom: 5px">
    <input id="divUtilities" @click="toggleUtilities()" type="button" class="btn" style="text-align: left;margin-left: 0px;font-size: 18px;font-weight: 600;
      background-color: #0a58ca;color: white" value="Utilities"/>
  </div>
  ...
  <!-- Accordian button for Search Section -->
   <div class="w-full" style="display: inline-flex;margin: auto;justify-content: left;border: solid black 0px;background-color: #0a58ca;color: white;border-radius: 5px;
    ...
    <input id="divApplicationInfo" @click="toggleSearch()" type="button" class="btn" style="text-align: left;margin-left: 0px;font-size: 18px;font-weight: 600;
      background-color: #0a58ca;color: white" value="Search"/>
  </div>
  ...
  <div class="w-full" style="display: inline-flex;margin: auto;justify-content: left;border: solid black 0px;background-color: #0a58ca;color: white;border-radius: 5px;
    ...
    <input id="divApplicationInfo" @click="toggleAppInfo()" type="button" class="btn" style="text-align: left;margin-left: 0px;font-size: 18px;font-weight: 600;
      background-color: #0a58ca;color: white" value="Application Information"/>
  </div>
  ...
  <div id="divApps" class="divAppWrapper" style="overflow-x: auto;margin: 0px auto;max-height: 200px;min-height: 100px;
      ...
      <tbody v-if="filteredIds.length>0">                          
        <tr v-for="(application,index) in filteredIds" :key="index" @mouseover="setOver(index)" @mouseleave="onLeave()" style="font-size: 20px;height: 50px">            
          <td  style="padding-bottom: 15px">                                      
            ...
            <input v-else-if="application.Selected=='false'" @click="addToSelected(index)" :id="'chkSelect'+index" name="inpSelect" type="checkbox" class="w3-check select"></td>
          ...
          <input @click="printLetter(index)" :id="'inpPrint'+index" name="inpPrint" type="button" class="w3-btn inpPrint" style="display: flex;margin: auto;text-align: center;
  ...
  <div class="w-full" style="display: flex;margin: auto;flex-direction: row;justify-content: center;align-items: center;flex-wrap: wrap;border: solid black 0px">
    <input id="divSearchBy" @click="toggleStudentInfo()" type="button" class="btn border" style="text-align: left;font-size: 18px;font-weight: 600;background-color: #0a58ca;
  ...
  <div v-if="applications.length>0" class="divDocumentationWrapper" id="divDocumentationWrapper" style="display: flex;margin: auto;justify-content: left;
    ...
    <div class="w-full" style="display: flex;margin: auto;flex-direction: row;justify-content: center;align-items: center;
      ...
      <input id="divDoc" type="button" class="btn border" style="text-align: left;font-size: 18px;font-weight: 600;background-color: #0a58ca;
  ...
  <div v-if="applications.length>0" id="divDisplay" style="display: flex;margin: auto;justify-content: center;margin-top: 0px;border: solid black 0px;position:fixed;
    ...
    <div id="divDisplay2" style="display: flex;margin: auto;justify-content: center;margin-top: 0px;margin-bottom: 0px;border: solid black 0px" class="w-full">            
      <input id="inpPrint" type="button" @click="printSelected()" value="Print Selected Letters" class="btn btn-primary w3-margin w-30rem" style="font-size: 24px" />              
      <input id="inpSend" type="button" @click="submitEmails()" value="Send Selected Letters" class="btn btn-primary w3-margin w-30rem" style="font-size: 24px" /></div>      
  </div>    
  <!-- Accordian button for Eligibility Letter Section -->
  <div v-if="user=='Mary Lou'" class="w-full" style="display: flex;margin: auto;flex-direction: row;justify-content: center;align-items: center;flex-wrap: wrap;
    border: solid black 0px;margin-top: 5px">
    <input id="divSearchBy" @click="toggleEditLetter()" type="button" class="btn border" style="text-align: left;font-size: 18px;font-weight: 600;background-color: #0a58ca;
  ...
  export default {
    ...
    setup() {
      ...
      return { printLetter,onLeave,submitEmail,submitEmails,setOver,setActive,toggleAppInfo,toggleStudentInfo,onActive,searchApps,selectedStatus,status,selectedReason,reasons,
        ...
        toggleEditLetter,toggleSearch,toggleUtilities,utilities }}}
</script>
<style>
