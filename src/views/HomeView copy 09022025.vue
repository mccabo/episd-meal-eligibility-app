    ...
    <table id="tblMain" class="table table-light table-hover">      
      <thead>
        <tr style="font-size: 20px">                             
          ...
          <th contenteditable="true" style="color: purple;border: solid black 0px;width: 80px;padding-left: 15px">Printed</th>          
          <th contenteditable="true" style="color: purple;border: solid black 0px;width: 150px;padding-left: 0px;padding-right: 0px;text-align: left;">Application Id</th>
          ...
          <th contenteditable="true" style="color: purple;border: solid black 0px;width: 75px;padding-left: 0px;padding-right: 0px;text-align: left;">Id</th>
          <th contenteditable="true" style="color: purple;border: solid black 0px;width: 175px;padding-left: 0px;padding-right: 0px;text-align: left;">Actions</th>          
        </tr>        
      </thead>       
  ...
  export default {
    ...
    setup() {
      ...
      const submitEmail = () => {
        ...
        window.location.href = "http://localhost:8100?emailSelected="+appIndex;}    
