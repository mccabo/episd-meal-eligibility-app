<template>
  ...
  <form id="frmMain" :action="'http://localhost:3000/printLetters?appIds='+this.selected" method="POST" style="border: solid black 0px;width: 100%;
    ...
    <div id="divApps" class="divAppWrapper" style="overflow-x: none;margin: 0px auto;max-height: 550px;min-height: 100px;margin-bottom: 15px;
      ...
      <table id="tblMain" style="border: solid black 0px" class="w-full">  
            ...
            <tr style="font-size: 22px">                             
              <th id="thSelect" contenteditable="true" style="color: purple;border: solid black 0px;width: 120px;padding-left: 0px;text-align: center;">{{ selectAll }} All</th>          
        ...
        <table id="tblMain" class="table table-hover">      
          <thead>
            <tr style="font-size: 22px">                             
              ...
              <th id="thAppId" contenteditable="true" style="color: purple;border: solid black 0px;width: 100px;padding-left: 15px;padding-right: 0px;text-align: left;">App Id</th>
              <th id="thLanguage" contenteditable="true" style="color: purple;border: solid black 0px;width: 100px;padding-left: 15px;padding-right: 0px;text-align: left;">Language</th>
              <th id="thFirstName" contenteditable="true" style="color: purple;border: solid black 0px;width: 150px;padding-left: 15px;padding-right: 0px;text-align: left;">First Name</th>
              <th id="thLastName" contenteditable="true" style="color: purple;border: solid black 0px;width: 150px;padding-left: 15px;padding-right: 0px;text-align: left;">Last Name</th>
              <th id="thEmail" contenteditable="true" style="color: purple;border: solid black 0px;width: 275px;padding-left: 15px;padding-right: 0px;text-align: left;">Email</th>
              ...
              <th id="thActions" contenteditable="true" style="color: purple;border: solid black 0px;width: 268px;padding-left: 0px;padding-right: 0px;text-align: center;">Actions</th>          
              <th id="thRow" contenteditable="true" style="color: purple;border: solid black 0px;width: 50px;padding-left: 0px;padding-right: 0px;text-align: center;">Row</th>
            </tr>        
          </thead>  

          <tbody v-if="this.jsonData">                          
            <tr v-for="(application,index) in filteredIds" :key="index"
              ...
              <td>                 
                ...
                <input v-else @click="handleClick('inpLanguage'+index)" @keyup="handleKeyUp(application.Id,index,'language')" 
                  @blur="handleBlur(application.Id,index,'language')" :id="'inpLanguage'+index" name="Language" :value="application.Language" 
                  style="border:solid black 1px;font-size: 22px;height: 40px;background-color: azure;">                 
              </td>            
              <td>
                ...
                <input v-else @click="handleClick('inpFirstName'+index)" @keyup="handleKeyUp(application.Id,index,'firstname')" 
                  @blur="handleBlur(application.Id,index,'firstname')" :id="'inpFirstName'+index" name="FirstName" :value="application.Guardians[0].FirstName" 
                  style="border:solid black 1px;font-size: 22px;height: 40px;background-color: azure">                
              </td>            
              <td>
                ...
                <input v-else @click="handleClick('inpLastName'+index)" @keyup="handleKeyUp(application.Id,index,'lastname')" 
                  @blur="handleBlur(application.Id,index,'lastname')" :id="'inpLastName'+index" name="LastName" :value="application.Guardians[0].LastName" 
                  style="border:solid black 1px;font-size: 22px;height: 40px;background-color: azure">                
              </td>
              <td>
                ...
                <input v-else @click="handleClick('inpEmail'+index)" @keyup="handleKeyUp(application.Id,index,'email')" 
                  @blur="handleBlur(application.Id,index,'email')" :id="'inpEmail'+index" name="Email" :value="application.Guardians[0].Email" 
                  style="border:solid black 1px;font-size: 22px;height: 40px;background-color: azure">                
              </td>
              ...
              <td>
                <div style="display: flex;margin: auto;">
                  <input :id="'inpPrint'+index" name="inpPrint" type="submit" class="w3-btn inpPrint" 
                    style="display: flex;margin: auto;text-align: center;margin-left: 20px;font-size: 18px;background-color: #F1F5F9;
                    color: black;width: 100px;border: solid black 1px" value="Print" disabled>
                  <input :id="'inpEmail'+index" name="inpEmail" type="submit" class="w3-btn inpEmail" 
                    style="display: flex;margin: auto;text-align: center;margin-left: 0px;font-size: 18px;background-color: #F1F5F9;
                    color: black;width: 100px;border: solid black 1px" value="Email" disabled>                
                  <input id="inpUpdateRow" name="inpUpdateRow" type="submit" class="w3-btn inpUpdateRow" 
                    style="display: flex;margin: auto;text-align: center;margin-left: 0px;font-size: 18px;background-color: #F1F5F9;
              ...
              <td @click="onActive(index,application.Id,application.Guardians[0].LastName,application.Guardians[0].FirstName,
                application.BatchNum)" style="font-size: 18px;color: black;
    ...
    <div v-if="this.jsonData" id="divEligibilityLetter" style="display: flex;margin: auto;font-size: 24px;border: solid black 0px;
  ...
  export default {
    ...
    setup() {
      ...
      return { printLetter,onLeave,submitEmail,submitEmails,setOver,setActive,toggleAppInfo,toggleStudentInfo,onActive,searchApps,selectedStatus,status,selectedReason,reasons,
        ...
        tester,readonly,handleClick,handleBlur,handleKeyUp }}}
</script>
<style>
