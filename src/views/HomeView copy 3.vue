<template> 
  ...
  <form @submit.prevent="handleSubmit"> -->
    {{ JSON.stringify(appArray) }}
  <form id="frmMain" :action="'http://localhost:3000/appIndex?frmData='+this.selected" method="POST" style="border: solid black 0px;width: 100%;max-width: none;">
  ...
  export default {
    ...
    setup() {
      ...
      const printData = () => {
        ...
        printButton.formAction = 'http://localhost:3000/shoeLetters?appString='+appString;
