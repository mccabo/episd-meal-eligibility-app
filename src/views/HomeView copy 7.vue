<template> 
  ...
  <formtodos Localhost serverData: {{ jsonData.Applications.length }}
   style="width: 100%;max-width: none;border: solid black 1px"></form>
  ...
  <form id="frmMain" :action="'http://localhost:3000/appIndex?frmData='+this.selected" method="POST" style="border: solid black 0px;width: 100%;
    ...
    <div class="w-full" style="display: inline-flex;margin: auto;justify-content: left;border: solid black 0px;color: white;border-radius: 5px;
      margin-bottom: 5px">d
      <input id="divSearchBy" @click="toggleStuentInfo()" class="btn" type="button" style="text-align: left;font-size: 25px;font-weight: 600;
